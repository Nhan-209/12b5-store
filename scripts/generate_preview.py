        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 bg-white mb-4" style="border: 1px solid var(--border-color) !important;">
                ...
                <div class="input-group mb-2">
                    <input type="text" class="form-control form-control-sm rounded-start-pill text-uppercase font-monospace" value="WELCOME2026">
                ...
                <div class="alert alert-success d-flex justify-content-between align-items-center mb-0 p-2 rounded-3 small">
                    <span><i class="bi bi-check-circle-fill me-1"></i> Đã giảm <strong>500.000 ₫</strong> (WELCOME2026)</span>
            ...
            <div class="card border-0 shadow-sm rounded-4 p-4 bg-white mb-4" style="border: 1px solid var(--border-color) !important;">
                ...
                <div class="row g-3 mb-4 small">
                    ...
                    <div class="col-md-6">
                        ...
                        <div><span class="badge bg-warning text-dark text-uppercase">Chờ Xử Lý & Xác Nhận</span></div>
                    </div>
                </div>
