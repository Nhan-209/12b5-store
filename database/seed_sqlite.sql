...
(1, 'Quản Trị Viên', 'admin@electro.vn', '$2y$10$w8T0M47c92rW2u8g8XzTceEcm74UvG3pL.d0rN/PqXm4a0mXbYJ0e', '0901234567', 'Số 1 Đại Cồ Việt, Hai Bà Trưng, Hà Nội', 'admin'),
(2, 'Nguyễn Văn An', 'customer@gmail.com', '$2y$10$w8T0M47c92rW2u8g8XzTceEcm74UvG3pL.d0rN/PqXm4a0mXbYJ0e', '0912345678', 'Số 123 Nguyễn Huệ, Quận 1, TP.HCM', 'customer'),
...
(1, 1, 1, 'iPhone 16 Pro Max 256GB Titan Tự Nhiên', 'iphone-16-pro-max-256gb', 'APL-IP16PM-256', 34990000.0, 36990000.0, 45, 1, 1, 'iphone16promax.jpg', 
 'Siêu phẩm mới nhất từ Apple trang bị vi xử lý Apple A18 Pro 3nm, khung viền Titanium chuẩn hàng không vũ trụ và nút Điều Khiển Camera.',
 'iPhone 16 Pro Max nâng tầm trải nghiệm công nghệ di động với màn hình Super Retina XDR OLED 6.9 inch, ProMotion 120Hz mượt mà cùng thời lượng pin xuất sắc nhất từ trước đến nay. Hệ thống 3 camera sau gồm cảm biến Fusion 48MP, Ultra Wide 48MP và Telephoto 5x 12MP.',
...
(2, 1, 2, 'Samsung Galaxy S24 Ultra 5G 256GB AI Phone', 'samsung-galaxy-s24-ultra-256gb', 'SS-S24U-256', 29990000.0, 33990000.0, 38, 1, 1, 's24ultra.jpg',
 ...
 'Samsung Galaxy S24 Ultra trang bị vi xử lý Snapdragon 8 Gen 3 for Galaxy cực kỳ mạnh mẽ, cụm camera 200MP zoom quang học 5x sắc nét cùng hàng loạt tính năng trí tuệ nhân tạo.',
...
(3, 2, 1, 'MacBook Pro 14 M3 Pro (18GB / 512GB SSD) Đen Không Gian', 'macbook-pro-14-m3-pro-512gb', 'APL-MBP14-M3P', 49990000.0, 52990000.0, 20, 1, 1, 'macbookpro14.jpg',
 'Sức mạnh đồ họa đỉnh cao với chip Apple M3 Pro 11 CPU / 14 GPU, màn hình Liquid Retina XDR độ sáng 1600 nits.',
 'MacBook Pro 14 inch M3 Pro là cỗ máy hoàn hảo cho lập trình viên, nhà sáng tạo nội dung và kỹ sư đồ họa. Thời lượng pin lên tới 18 tiếng liên tục, âm thanh 6 loa studio vòm spatial audio.',
...
(4, 2, 4, 'Laptop Gaming ASUS ROG Zephyrus G16 (Core Ultra 9 / RTX 4070 / 32GB / 1TB)', 'asus-rog-zephyrus-g16-gu605', 'ASUS-ROG-G16', 58990000.0, 62990000.0, 15, 1, 1, 'zephyrusg16.jpg',
 ...
 'ASUS ROG Zephyrus G16 GU605 kết hợp giữa hiệu năng gaming đỉnh bảng và sự thanh lịch của dòng ultrabook mỏng chỉ 1.49cm. Trang bị chip Intel Core Ultra 9 185H thế hệ mới tích hợp NPU AI.',
...
(5, 2, 5, 'Dell XPS 13 Plus 9320 (Core i7-1360P / 16GB / 512GB / 3.5K OLED)', 'dell-xps-13-plus-9320', 'DELL-XPS13P', 41990000.0, 45000000.0, 12, 0, 1, 'dellxps13.jpg',
...
(6, 3, 1, 'iPad Pro M4 11 inch 256GB Wi-Fi (Tấm nền Ultra Retina XDR Tandem OLED)', 'ipad-pro-m4-11-256gb', 'APL-IPADM4-11', 28990000.0, 30990000.0, 25, 1, 1, 'ipadm4.jpg',
 'Thiết kế mỏng nhất lịch sử Apple chỉ 5.3mm, trang bị chip Apple M4 thế hệ mới và công nghệ màn hình Tandem OLED đột phá.',
 'iPad Pro M4 mang đến hiệu năng đồ họa mạnh mẽ hơn gấp 4 lần thế hệ trước, hỗ trợ Apple Pencil Pro với cử chỉ bóp nhẹ xoay thân bút.',
...
(7, 4, 3, 'Tai nghe không dây chống ồn Sony WH-1000XM5 Hi-Res Audio', 'sony-wh-1000xm5-black', 'SONY-WHXM5', 7490000.0, 8990000.0, 50, 1, 1, 'wh1000xm5.jpg',
 ...
 'Sony WH-1000XM5 được các audiophile và chuyên gia âm thanh đánh giá cao với khả năng tối ưu hóa chống ồn tự động theo môi trường.',
...
(8, 4, 1, 'Tai nghe Apple AirPods Pro 2 (Cổng USB-C / Chống ồn chủ động 2X)', 'airpods-pro-2-usbc', 'APL-APP2-USBC', 5690000.0, 6190000.0, 60, 1, 1, 'airpodspro2.jpg',
 'Trang bị chip Apple H2 mang đến khả năng khử ồn chủ động gấp đôi, chế độ Xuyên Âm thích ứng và chuẩn sạc USB-C phổ thông.',
 'AirPods Pro thế hệ 2 đem lại trải nghiệm nghe đắm chìm với Âm Thanh Không Gian Cá Nhân Hóa, cảm biến vuốt điều chỉnh âm lượng.',
...
(9, 5, 1, 'Apple Watch Series 10 GPS 46mm Vỏ Nhôm Dây Cao Su', 'apple-watch-series-10-46mm', 'APL-AWS10-46', 11490000.0, 12290000.0, 30, 1, 1, 'applewatchs10.jpg',
 ...
 'Apple Watch Series 10 bổ sung cảm biến nhiệt độ nước và độ sâu thích hợp cho bơi lội lặn nông, phát hiện ngưng thở khi ngủ.',
...
(10, 5, 2, 'Samsung Galaxy Watch Ultra 47mm LTE Titan Xám', 'samsung-galaxy-watch-ultra-47mm', 'SS-GWU-47', 15990000.0, 16990000.0, 18, 0, 1, 'galaxywatchultra.jpg',
 ...
 'Galaxy Watch Ultra sở hữu còi báo động cứu hộ khẩn cấp 86dB, GPS băng tần kép L1+L5 chính xác từng mét kể cả trong hẻm sâu.',
...
(11, 6, 7, 'Củ sạc nhanh Xiaomi 67W GaN Siêu Nhỏ Gọn (2C + 1A)', 'cu-sac-nhanh-xiaomi-67w-gan', 'MI-CHARGER-67W', 590000.0, 790000.0, 120, 0, 1, 'charger67w.jpg',
 'Công nghệ bán dẫn GaN thế hệ 3 giúp giảm 40% kích thước, hỗ trợ công suất 67W sạc cùng lúc 3 thiết bị an toàn và ổn định.',
 'Củ sạc nhanh tương thích đa giao thức PD 3.0, QC 4.0+, UFCS sạc được cho cả laptop, máy tính bảng và điện thoại.',
 '{"power": "67W Max", "ports": "2x USB-C + 1x USB-A", "technology": "Gallium Nitride (GaN III)", "protocols": "PD3.0, QC4+, PPS, UFCS"}', 4.9, 58, 145),

(12, 1, 7, 'Xiaomi 14 Ultra 5G 512GB Ống Kính Leica Huyền Thoại', 'xiaomi-14-ultra-512gb', 'MI-14U-512', 26990000.0, 29990000.0, 22, 1, 1, 'xiaomi14ultra.jpg',
 ...
 'Xiaomi 14 Ultra trang bị Snapdragon 8 Gen 3, màn hình C8 AMOLED WQHD+ 120Hz 3000 nits, sạc nhanh 90W có dây và 80W không dây.',
...
(1, 'WELCOME2026', 'fixed', 500000.0, 10000000.0, '2026-12-31 23:59:59', 500, 12, 1),
(2, 'TECHSALE10', 'percent', 10.0, 5000000.0, '2026-12-31 23:59:59', 200, 35, 1),
(3, 'VIPMEMBER', 'fixed', 1000000.0, 20000000.0, '2026-12-31 23:59:59', 100, 8, 1);
...
(1, 2, 'ORD-2026-0001', 'Nguyễn Văn An', 'customer@gmail.com', '0912345678', 'Số 123 Nguyễn Huệ, Quận 1, TP.HCM', 'cod', 'pending', 'completed', 34990000.0, 500000.0, 34490000.0, 'Giao hàng giờ hành chính', '2026-09-10 10:15:00'),
(2, 2, 'ORD-2026-0002', 'Nguyễn Văn An', 'customer@gmail.com', '0912345678', 'Số 123 Nguyễn Huệ, Quận 1, TP.HCM', 'bank_transfer', 'paid', 'shipping', 7490000.0, 0.0, 7490000.0, 'Gọi trước khi giao', '2026-09-12 14:30:00'),
(3, 3, 'ORD-2026-0003', 'Trần Thị Mai', 'mai.tran@gmail.com', '0987654321', 'Số 45 Lê Lợi, Quận Hải Châu, Đà Nẵng', 'bank_transfer', 'paid', 'processing', 49990000.0, 1000000.0, 48990000.0, 'Đóng gói bọc xốp chống sốc cẩn thận', '2026-09-15 09:00:00'),
(4, 2, 'ORD-2026-0004', 'Nguyễn Văn An', 'customer@gmail.com', '0912345678', 'Số 123 Nguyễn Huệ, Quận 1, TP.HCM', 'cod', 'pending', 'pending', 5690000.0, 0.0, 5690000.0, '', '2026-09-16 16:45:00');

INSERT INTO order_items (id, order_id, product_id, product_name, product_sku, unit_price, quantity, subtotal) VALUES
(1, 1, 1, 'iPhone 16 Pro Max 256GB Titan Tự Nhiên', 'APL-IP16PM-256', 34990000.0, 1, 34990000.0),
(2, 2, 7, 'Tai nghe không dây chống ồn Sony WH-1000XM5 Hi-Res Audio', 'SONY-WHXM5', 7490000.0, 1, 7490000.0),
(3, 3, 3, 'MacBook Pro 14 M3 Pro (18GB / 512GB SSD) Đen Không Gian', 'APL-MBP14-M3P', 49990000.0, 1, 49990000.0),
(4, 4, 8, 'Tai nghe Apple AirPods Pro 2 (Cổng USB-C / Chống ồn chủ động 2X)', 'APL-APP2-USBC', 5690000.0, 1, 5690000.0);
